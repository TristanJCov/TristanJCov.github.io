...
const Header = ({ currentRoute, mode, setMode }) => {
  ...
  return (
    <header className="sticky top-0 bg-light-wisteria-50 dark:bg-pale-slate-950 text-light-wisteria-600 shadow-lg shadow-light-wisteria-100 dark:shadow-light-wisteria-850 dark:text-light-wisteria-400 transition-colors" >
